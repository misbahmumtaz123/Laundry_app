        ...
        body: GetBuilder<StoreDataContoller>(builder: (context) {
          return storeDataContoller.isLoading
              ? RefreshIndicator(
                                                  ...
                                                  children: [
                                                    ...
                                                    Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        // Text(
                                                        //   "${storeDataContoller.storeDataInfo?.catwiseproduct[index].productdata.length.toString()} Pound",
                                                        //   style: TextStyle(
                                                        //     fontFamily: FontFamily
                                                        //         .gilroyMedium,
                                                        //     color: greytext,
                  ...
                  //                               ),
                  //                             ),
                  //                             storeDataContoller.currentIndex ==
                  //                                     index
                  //                                 ? Container(
                  //                                     height: 4,
                  //                                     width: 80,
                  ...
                  //                         .storeDataInfo?.catwiseproduct.length,
                  //                     onPageChanged: (value) {
                  //                       storeDataContoller.changeIndexInCategory(
                  //                           index: value);
                  //                       setState(() {
                  //                         currentIndex = value;
                  //                         scrollController.animateTo(
                    ...
                    Expanded(
                      child: Container(
                        ...
                        child: prductAttribute.toSet().length > 1
                            ...
                            //                 .title) {
                            //           setState(() {
                            //             widget.normalPrice = storeDataContoller
                            //                 .storeDataInfo!
                            //                 .catwiseproduct[widget.index1 ?? 0]
                            //                 .productdata[widget.index ?? 0]
                            //                 .productInfo[i]
                            ...
                            //             widget.attributeId = storeDataContoller
                            //                 .storeDataInfo!
                            //                 .catwiseproduct[widget.index1 ?? 0]
                            //                 .productdata[widget.index ?? 0]
                            //                 .productInfo[i]
                            ...
                            //                     .productInfo[i]
                            //                     .productDiscount;
                            //             widget.title = storeDataContoller
                            //                 .storeDataInfo!
                            //                 .catwiseproduct[widget.index1 ?? 0]
                            //                 .productdata[widget.index ?? 0]
                            //                 .productInfo[i]
